...
class PurchaseOrderDetail extends Model
{
    ...
    {
        return $this->belongsTo(Aset::class, 'barang_id');
    }
    ...
    {
        return $query->filterBy(['barang_id']);
    }
    ...
    public function handleDetailPurchaseStoreOrUpdate($request)
    {
    ...
    public function handleDetailPurchaseDestroy()
    {
        $this->beginTransaction();
        try {
            $this->saveLogNotify();

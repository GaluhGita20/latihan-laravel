...
{
    protected $module   = 'master.org.unit';
    protected $routes   = 'master.org.unit';
    protected $views    = 'master.org.unit';
    protected $perms    = 'master.org.unit';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Unit Pelaksana' => route($this->routes . '.index'),
                ]
            ]
        );
    }
    ...
    {
        $user = auth()->user();
        $records = Struct::unit()->filters()->dtGet();
    ...
    {
        $record = new Struct;
        return $record->handleStoreOrUpdate($request, 'unit');
    }
    ...
    public function importSave(Request $request)
    {
        ...
        $record = new Struct;
        return $record->handleImport($request, 'unit');
    }
}

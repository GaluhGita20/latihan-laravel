...
{
    protected $module   = 'master.org.subbranch';
    ...
    public function __construct()
    {
        $this->prepare([
            ...
            'breadcrumb' => [
                ...
                'Cabang Pembantu' => route($this->routes.'.index'),
            ]
        ]);
    }
    ...
    {
        $user = auth()->user();
        $records = Struct::subbranch()->filters()->dtGet();
    ...
    public function update(SubbranchRequest $request, Struct $record)
    {
        return $record->handleStoreOrUpdate($request, 'subbranch');
    }

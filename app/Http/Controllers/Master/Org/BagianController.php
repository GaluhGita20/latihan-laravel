...
use App\Http\Requests\Master\Org\BagianRequest;
use App\Models\Master\Org\Struct;
use Illuminate\Http\Request;

class BagianController extends Controller
{
    protected $module   = 'master.org.bagian';
    protected $routes   = 'master.org.bagian';
    protected $views    = 'master.org.bagian';
    protected $perms    = 'master.org.bagian';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Bagian' => route($this->routes . '.index'),
                ]
            ]
        );
    }
    ...
    {
        $user = auth()->user();
        $records = Struct::bagian()->filters()->dtGet();
    ...
    {
        $record = new Struct;
        return $record->handleStoreOrUpdate($request, 'bagian');
    }
    ...
    public function update(BagianRequest $request, Struct $record)
    {
        return $record->handleStoreOrUpdate($request, 'bagian');
    }
    ...
    public function importSave(Request $request)
    {
        ...
        $record = new Struct;
        return $record->handleImport($request, 'bagian');
    }
}

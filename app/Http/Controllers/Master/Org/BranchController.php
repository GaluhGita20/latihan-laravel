...
use App\Http\Requests\Master\Org\BranchRequest;
use App\Models\Master\Org\Struct;
use Illuminate\Http\Request;

class BranchController extends Controller
{
    protected $module   = 'master.org.branch';
    protected $routes   = 'master.org.branch';
    protected $views    = 'master.org.branch';
    ...
    public function __construct()
    {
        $this->prepare([
            ...
            'breadcrumb' => [
                ...
                'Cabang' => route($this->routes.'.index'),
            ]
        ]);
    }
    ...
    {
        $user = auth()->user();
        $records = Struct::branch()->filters()->dtGet();
    ...
    {
        $record = new Struct;
        return $record->handleStoreOrUpdate($request, 'branch');
    }
    ...
    public function update(BranchRequest $request, Struct $record)
    {
        return $record->handleStoreOrUpdate($request, 'branch');
    }
    ...
    public function importSave(Request $request)
    {
        ...
        $record = new Struct;
        return $record->handleImport($request, 'branch');
    }
}

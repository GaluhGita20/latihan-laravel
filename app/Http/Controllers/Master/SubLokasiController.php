...
class SubLokasiController extends Controller
{
            ...
            [
                'tableStruct' => [
                    'datatable_1' => [
                        ...
                        $this->makeColumn('name:name|label:Struktur|className:text-left'),
                        $this->makeColumn('name:name|label:Lokasi|className:text-left'),
    ...
    {
        $user = auth()->user();
        $records = SubLokasi::grid()->filters()->dtGet();

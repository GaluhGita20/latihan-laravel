...
@section('modal-body')
	...
	<div class="form-group row">
		<label class="col-sm-12 ml-4 col-form-label">{{ __('Kota/Kabupaten') }}</label>
		<div class="col-sm-12 parent-group">

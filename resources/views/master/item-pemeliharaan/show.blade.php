...
@section('modal-body')
	<div class="form-group row">
		...
		<div class="col-md-12 parent-group">
			<select disabled name="tipe_pemeliharaan_id" class="form-control base-plugin--select2-ajax tipe_id"
	...
	<div class="form-group row">
		...
		<div class="col-sm-12 parent-group">
			<input disabled type="text" name="name" class="form-control" placeholder="{{ __('Nama') }}" value="{{ $record->name }}">
		</div>
	</div>
	<div class="form-group row">

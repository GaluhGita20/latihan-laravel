...
@section('modal-body')
	...
	{{-- <div class="form-group row">
		<label class="col-sm-3 col-form-label">{{ __('Provinsi') }}</label>
		<div class="col-sm-9 parent-group">
			<select disabled class="form-control base-plugin--select2" id="provinceCtrl" name="city_id">
	...
	<div class="form-group row">
		<label class="col-sm-3 col-form-label">{{ __('Kota') }}</label>
		<div class="col-sm-9 parent-group">
			<select disabled class="form-control base-plugin--select2" id="cityCtrl" name="city_id">

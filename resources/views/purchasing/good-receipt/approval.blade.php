                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 parent-group">
                            ...
                            @if(request()->route()->getName() == $routes.'.approval') disabled @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 parent-group">
                            <textarea required name="catatan" @if(request()->route()->getName() == $routes.'.approval') disabled @endif class="form-control" placeholder="{{ __('Catatan') }}">{{ $record->goodReceipt->catatan }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">

                ...
                <form action="{{ route($routes.'.updateProfile') }}" method="post" autocomplete="off">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ asset('assets/media/users/blank.png')  }})">
                                    <img class="image-input-wrapper show" style="background-image: url({{ asset(auth()->user()->image_path)}})">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input class="form-control form-control-lg form-control-solid" type="text" value="{{ auth()->user()->roles_imploded }}" readonly>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="phone" value="{{ auth()->user()->phone }}" placeholder="{{ __('Telepon') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="email" value="{{ auth()->user()->email }}" placeholder="{{ __('Email') }}">
                                </div>
                            </div>
                        </div>
                    </div>

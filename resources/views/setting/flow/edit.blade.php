...
@section('card-title') 
	Assign Permission <small><b> : {{ $record->name }}</b></small>
@endsection
                ...
                @forelse ($record->flows as $flow)
                    <tr data-key="{{ $loop->iteration }}">
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                {{-- <button type="button" class="btn btn-danger btn-pill btn-sm btn-icon remove-flow" {{ $loop->count <= 1 ? 'disabled' : '' }}><i class="fa fa-trash"></i></button> --}}
                ...
                @empty
                    <tr data-key="1">
                        ...
                        <td class="text-center justify-content-center">
                            <div class="d-flex justify-content-center">
                                {{-- <button type="button" class="btn btn-danger btn-pill btn-sm btn-icon remove-flow" disabled><i class="fa fa-trash"></i></button> --}}
                                <button type="button" class="btn btn-danger btn-pill btn-sm btn-icon remove-flow"><i class="fa fa-trash"></i></button>
                            </div>
                        </td>
                    </tr>

                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9 parent-group">
                                <input type="text" name="work_order_id" class="form-control" placeholder="{{ __('ID Work Order') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9 parent-group">
                                ...
                                "format" => "d/m/yyyy", ])' data-post="done_target_date" placeholder="{{ __('Tgl Target Selesai') }}">
                            </div>
                        </div>
                    </div>
                    <!-- End Of Left -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7 parent-group">
                                <textarea name="description" class="form-control" rows="3" placeholder="{{ __('Deskripsi') }}"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-5 col-form-label">{{ __('Perkiraan Biaya') }}</label>
                            <div class="col-sm-12 col-md-7 parent-group">
                                <input type="text" id="estimation_cost" name="estimation_cost" class="form-control" placeholder="{{ __('Perkiraan Biaya') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-5 col-form-label">{{ __('Diminta Oleh') }}</label>
                            <div class="col-sm-12 col-md-7 parent-group">
                                <input type="text" id="request_by" name="request_by" class="form-control" placeholder="{{ __('Diminta Oleh') }}">
                            </div>
                        </div>
                        <div class="form-group row">
